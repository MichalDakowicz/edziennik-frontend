...
- _Blur:_ 32px | _Spread:_ -4px | _Color:_ `on-surface` at 6% opacity.
...
- **Status Chips:**
- _Attendance (Success):_ `tertiary_fixed` background with `on_tertiary_fixed` text.
- _Pending (Warning):_ Custom amber using a 10% opacity tint of `tertiary`.
