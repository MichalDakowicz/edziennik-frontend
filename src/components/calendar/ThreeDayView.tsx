...
export function ThreeDayView({ date, timetable, events, homework }: ThreeDayViewProps) {
    ...
    <div className="space-y-4">
      ...
      {hasAllDay && (
        <div className="grid grid-cols-3 gap-2">
          {days.map((day) => {
            ...
            if (dayEvents.length === 0 && dayHw.length === 0)
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[480px]">
          {/* Header */}
          <div className="grid grid-cols-[76px_repeat(3,1fr)] gap-2 mb-2">
            <div />
            {days.map((day) => {
          ...
          {/* Period rows */}
          {hours.map((hour) => (
            <div key={hour.id} className="grid grid-cols-[76px_repeat(3,1fr)] gap-2 mb-1.5">
